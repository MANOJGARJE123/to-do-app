  ...
  return (
    <div className="w-64 bg-white shadow-md h-screen fixed">
      ...
      <nav className="mt-4">
        <ul>
          <li className="mb-2">
            <NavLink to="/add-task" className="flex items-center p-2 text-red-500 hover:bg-red-100 rounded-md mx-2" activeClassName="bg-red-100">
          ...
          <li className="mb-2">
            <NavLink to="/search" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-gray-100">
          ...
          <li className="mb-2">
            <NavLink to="/inbox" className="flex items-center p-2 text-gray-700 bg-red-100 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-red-100">
          ...
          <li className="mb-2">
            <NavLink to="/today" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-gray-100">
          ...
          <li className="mb-2">
            <NavLink to="/upcoming" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-gray-100">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
              Upcoming
            </NavLink>
          </li>
          <li className="mb-2">
            <NavLink to="/filters-labels" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-gray-100">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"></path></svg>
              Filters & Labels
            </NavLink>
          </li>
          <li className="mb-2">
            <NavLink to="/completed" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-gray-100">
        ...
        <div className="mt-6 mx-2">
          ...
          <ul className="mt-2">
            <li className="mb-2">
              <NavLink to="/project/getting-started" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md" activeClassName="bg-gray-100">
      ...
      <div className="absolute bottom-4 left-0 w-full p-4 border-t">
        <ul>
          <li className="mb-2">
            <NavLink to="/add-team" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-gray-100">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"></path></svg>
              Add a team
            </NavLink>
          </li>
          <li>
            <NavLink to="/help-resources" className="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md mx-2" activeClassName="bg-gray-100">
